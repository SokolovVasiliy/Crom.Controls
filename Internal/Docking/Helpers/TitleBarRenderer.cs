...
namespace Crom.Controls.Docking
{
    ...
    internal class TitleBarRenderer
    {
        ...
        public void Draw(Font font, Graphics graphics, Color c1, Color c2)
        {
            Rectangle titleBounds = TitleBarBounds;
            //Rectangle titleBounds = new Rectangle(TitleBarBounds.X, TitleBarBounds.Y, TitleBarBounds.Width, TitleBarBounds.Height + 25);
            Rectangle captionButtonsBounds = GetCaptionButtonsBounds();

            using (LinearGradientBrush backBrush = new LinearGradientBrush(titleBounds, c1, c2, LinearGradientMode.Vertical))
            {
            ...
            int iconSize = Math.Max(0, Math.Min(18, titleBounds.Height - 4));
            int iconTop = (titleBounds.Height - iconSize) / 2 + 1;
            Rectangle iconBounds = new Rectangle(titleBounds.Left + 10, iconTop, iconSize, iconSize);
        ...
        private void DrawCaptionButtons(Rectangle captionButtonsBounds, Graphics graphics)
        {
            ...
            int width = 10;
            int height = 10;
            int x = captionButtonsBounds.X + (edge - width) / 2 - 5;
            int y = captionButtonsBounds.Y + (edge - height) / 2 ;
