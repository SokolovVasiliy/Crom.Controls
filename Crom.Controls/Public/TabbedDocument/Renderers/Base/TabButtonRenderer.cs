...
namespace Crom.Controls.TabbedDocument
{
    ...
    public abstract class TabButtonRenderer
    {
        ...
        public abstract void Draw(Rectangle bounds, string text, bool selected, Font font, Graphics graphics);
        ...
        public abstract Rectangle GetFirstButtonBounds(Rectangle panelBounds, bool hasScroll, int scrolPos, string text, Font font, Graphics graphics);
        ...
        public abstract Rectangle GetNextButtonBounds(Rectangle previousBounds, string text, Font font, Graphics graphics);
