...
namespace Crom.Controls.Test
{
    ...
    public class DockTest : Form
    {
        ...
        public DockTest()
        {
            ...
            _docker.PreviewRenderer = new CustomPreviewRenderer1();
        ...
        private static Form CreateTestForm(Guid identifier)
        {
            ...
            {
                return CreateTestForm(700, 100, 150, 450, Color.LightGray, "Form 2");
            }
            ...
            {
                return CreateTestForm(700, 100, 200, 150, Color.LightGray, "Form 5 - [close disabled]");
            }
            else if (identifier == new Guid("1da6e328-d158-47de-a4ea-14172c287006"))
            {
                return CreateTestForm(700, 100, 200, 150, Color.LightGray, "Form 6");
            }
